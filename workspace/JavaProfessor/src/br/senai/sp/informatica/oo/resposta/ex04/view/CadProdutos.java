...
public class CadProdutos extends JFrame implements ActionListener, ChangeListener {
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(tfValor, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(tabbedPane, GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
					.addGap(18)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(btnInserir)
						.addComponent(btnSair)
		...
		if(botao.equals(btnInserir)) {
			...
			if(verificacao.equals(StatusValidador.OK)) {
				...
				if(aba.equals(panelAliment)) {
					...
					prod.setValidade(tfValidade.getValue());
					prod.setProducao(tfProducao.getValue());
					...
					prod.setDescricao(tfDescr.getText());
					prod.setValor(tfValor.getValue());
					prod.setCodigoFornecedor(tfCodforn.getValue());
					prod.setFornecedor(tfNomeForn.getText());
